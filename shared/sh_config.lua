...
Config.RunAmount = math.random(4, 6) -- How many drop-offs the player can make each run.
...
Config.OxyChance = 60 -- %Chance to receive oxy
Config.OxyItem = 'oxy'

Config.RareLoot = 20 -- %Chance to receive a rare loot item
Config.RareLootItem = 'markedbills' -- Rare loot item
